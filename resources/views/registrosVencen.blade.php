        ...
        <table id="table_id" class="table table-hover table-striped table-responsive-sm activos" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{!! $resultado !!}</td>
                    <td>
                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal-{{ $value->noRegistro }}">
                        Ver QR
                        </button>
                    </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <img src="{{ asset('https://informatica.simasatechnologies.com/cat/public/' . $value->qrPieza) }}" alt="QR Code" width="200">
                        <br>
                        <br>
                        <a href="{{ route('mostrarInformacion', ['id' => $value->noRegistro]) }}" class="btn btn-warning">Mostrar Información</a>
                    </div>
                    </center>
